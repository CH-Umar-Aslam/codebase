    ...
    >
      ...
      <div className={`hero-section  sm:max-w-7xl h-[400px]   px-4 sm:px-12 mx-auto flex flex-col md:flex-row  lg:gap-0 items-center justify-center`}>
        ...
        <div className="lg:w-1/2 lg:mr-8 flex flex-col items-center lg:items-start">
          ...
          <p className='text-sm text-slate-200 text-center md:text-left tracking-wider'>Passionate about using technology to solve real-world problems and create innovative solutions that make a lasting impact.</p>
          {/* bg-[#3e464c] */}

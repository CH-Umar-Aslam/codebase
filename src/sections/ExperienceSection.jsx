...
const Experience = () => {
  return (
    <div id="experiencesection" className="font-Poppins border   border-blue-200 mb-[8%] p-6 rounded-lg shadow-md">
      ...
      <div className="border-l-4 border-blue-500 pl-4">
        ...
        <ul className='pl-1text-[15px] sm:text-[16px] text-white p-4 '>

  ...
  return (
    <div id="experiencesection" className="bg-gray-100 mb-[8%] p-6 rounded-lg shadow-md">
      ...
      <div className="border-l-4 border-blue-500 pl-4">
        <h3 className="text-xl font-semibold text-gray-800">React.js Developer at <a href="https://recgenz.com" className="text-blue-600 hover:underline">RecGenz</a></h3>
        <p className="text-gray-600 mb-2">January 2024 - Present</p>

        <ul className='pl-1 text-pretty'>
          <li> <span className='mx-2 '>- </span> Led the development of <b> RecGenz’s company website </b> using React and Tailwind CSS for optimal functionality and design consistency.</li>
          ...
          <li > <span className='mx-2 '>- </span>Implemented <b>Nodemailer functionality</b> using Node.js and Express.js, contributing to a seamless user experience.
          </li>
